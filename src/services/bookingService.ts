...
export const createBookingFromQuote = async (quoteId: string, hotelId: string): Promise<Booking | null> => {
  try {
    ...
    // Note: booking_reference is auto-generated by the database trigger, so we don't include it here
    const bookingData = {
      quote_id: quote.id,
      client: quote.client,
      hotel_id: hotelId,
    ...
    // Use type assertion to tell TypeScript this is okay even without 'booking_reference'
    // The booking_reference will be auto-generated by a database trigger
...
export const createVoucherForBooking = async (bookingId: string): Promise<TravelVoucher | null> => {
  try {
    ...
    // Note: voucher_reference is auto-generated by the database trigger, so we don't include it here
    const voucherData = {
    ...
    // Use type assertion to tell TypeScript this is okay even without 'voucher_reference'
    // The voucher_reference will be auto-generated by a database trigger
    const { data: newVoucher, error } = await supabase
      .from('travel_vouchers')
      .insert(voucherData as any)
      .select()
      .single();
