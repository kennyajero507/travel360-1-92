...
export const createInquiry = async (inquiryData: InquiryInsertData): Promise<InquiryData> => {
  ...
  try {
    ...
    // Prepare the data for insertion - provide temporary enquiry_number that will be overridden by trigger
    const insertData = {
      id: inquiryData.id,
      enquiry_number: 'TEMP', // Temporary value, will be auto-generated by database trigger
