...
export const createInquiry = async (inquiryData: InquiryInsertData): Promise<InquiryData> => {
  try {
    ...
    // Prepare data for insert - match the database schema exactly
    const insertData = {
      ...
      days_count: inquiryData.days_count,
      nights_count: inquiryData.nights_count,
      ...
      // Let the database auto-generate id and enquiry_number
